...
// инициализирую общие данные страницы доступные через пакет
// для доступа обовлятора
var DataPage = &Data{
	GroupOrders:          make(domain.OrderInfoSlice, 0),
	PackageOrders:        make(domain.OrderInfoSlice, 0),
	SelectedGroupOrder:   &domain.OrderInfo{},
	SelectedPackageOrder: &domain.OrderInfo{},
}
