		...
		Children: []dcl.Widget{
			dcl.Composite{
				...
				Children: []dcl.Widget{
					...
					dcl.Composite{
						...
						Children: []dcl.Widget{
							...
							dcl.Label{
								...
								Alignment: dcl.AlignHNearVCenter,
								// Text:      dcl.Bind("PageData.CountTtn"),
							},
							dcl.Label{
					...
					// 			Alignment: dcl.AlignHNearVCenter,
					// 			Text:      "возможно подбирать из разных партий остатков (Split)",
					// 			OnCheckedChanged: func() {
					...
					dcl.Composite{
						...
						Children: []dcl.Widget{
							dcl.CheckBox{
								...
								Alignment: dcl.AlignHNearVCenter,
								Text:      "при повторном импорте черновики импортированных ТТН удаляются (ReImport)",
								OnCheckedChanged: func() {
					...
					dcl.Composite{
						...
						Children: []dcl.Widget{
							dcl.PushButton{
								...
								// Enabled:   dcl.Bind("PageData.CountTtn != ''"),
								Text:      "Анализ",
